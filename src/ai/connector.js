...
const DISPLAY_NAMES = Object.freeze({ '9router': '9Router', orcarouter: 'OrcaRouter', agentrouter: 'BluesMinds', 'google-flow': 'Google Flow', 'google-veo': 'Google Veo', 'google-imagen': 'Google Imagen', 'google-gemini': 'Google Gemini', 'openai-images': 'OpenAI Images', vidu: 'Vidu', zark: 'Zark', omni: 'Omni' });
