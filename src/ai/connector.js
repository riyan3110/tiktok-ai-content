...
const CAPABILITIES = Object.freeze({ orcarouter: ['text', 'image', 'video'], 'google-flow': ['image', 'video'], 'google-veo': ['video'], 'google-imagen': ['image'], 'google-gemini': ['image'], 'openai-images': ['image'], vidu: ['image', 'video'], omni: ['image', 'video'] });
