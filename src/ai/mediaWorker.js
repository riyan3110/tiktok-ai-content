...
class MediaGenerationWorker {
  ...
  enqueue(body) { connector.validateGeneration(this.db, body); const id = body.id || crypto.randomUUID(); this.pending.push({ ...body, id }); queueMicrotask(() => this.drain()); return id; }
