...
const CACHE_BUST_VERSION = 'cache-20260926-glass-cards2';
...
function createSiteAuthGateway(innerApp, config) {
  ...
  const sendAppShell = async (req, res, next) => {
    try {
      ...
      const criticalThemeStyles = '<style>html.aiads-neo-theme[data-theme="light"]{background:#07080c}html.aiads-neo-theme[data-theme="light"] body{background:#07080c;color:#151b2b}html.aiads-neo-theme[data-theme="dark"]{background:#07080c}html.aiads-neo-theme[data-theme="dark"] body{background:#07080c;color:#eef2f8}</style>';
