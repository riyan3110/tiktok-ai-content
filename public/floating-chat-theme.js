(() => {
  ...
  css.textContent = `
    ...
    .neo-feature-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.neo-feature-card{position:relative;display:grid;align-content:end;min-height:168px;padding:14px;border:2px solid var(--neo-line);border-radius:18px;background:var(--neo-yellow);box-shadow:var(--neo-shadow);overflow:hidden;cursor:pointer}.neo-feature-card:nth-child(2){background:var(--neo-purple)}.neo-feature-card .neo-feature-art{position:absolute;right:12px;top:10px;width:52px;height:52px;opacity:.22;color:var(--neo-ink)}.neo-feature-card .neo-feature-art svg{width:100%;height:100%}.neo-feature-card b{font-size:1.05rem}.neo-feature-card small{margin-top:5px;line-height:1.35;color:#475166}.neo-feature-card .neo-card-button{justify-self:start;margin-top:11px;padding:7px 11px;border:1.5px solid var(--neo-line);border-radius:9px;background:var(--neo-white);font-size:.72rem;font-weight:900}
    .neo-news-carousel{position:relative;display:grid;gap:10px;padding:12px;border:2px solid var(--neo-line);border-radius:18px;background:var(--neo-white);box-shadow:var(--neo-shadow);overflow:hidden}.neo-news-head{display:flex;align-items:center;justify-content:space-between;gap:8px}.neo-news-head b{font-size:.88rem}.neo-news-head small{font-size:.65rem}.neo-news-track{display:grid;grid-auto-flow:column;grid-auto-columns:calc(50% - 5px);gap:10px;overflow-x:auto;scroll-snap-type:x mandatory;scrollbar-width:none;-webkit-overflow-scrolling:touch;padding-bottom:2px}.neo-news-track::-webkit-scrollbar{display:none}.neo-news-card{scroll-snap-align:start;position:relative;min-height:186px;display:flex;flex-direction:column;justify-content:flex-end;padding:0;overflow:hidden;border:2px solid var(--neo-line);border-radius:14px;background:var(--neo-soft);color:var(--neo-ink);text-align:left}.neo-news-card img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}.neo-news-card::after{content:"";position:absolute;inset:35% 0 0;background:linear-gradient(transparent,rgba(21,27,43,.92))}.neo-news-copy{position:relative;z-index:1;padding:12px;color:#fff}.neo-news-copy b{display:block;color:#fff;font-size:.82rem;line-height:1.25}.neo-news-copy small{display:block;margin-top:5px;color:#e7eaf0;font-size:.64rem}.neo-news-copy em{display:inline-block;margin-top:8px;padding:4px 7px;border:1px solid #fff8;border-radius:999px;font-size:.58rem;font-style:normal}.neo-news-empty{padding:22px;text-align:center;color:var(--neo-muted);font-size:.75rem}.neo-news-toast{position:absolute;right:10px;bottom:10px;z-index:3;padding:7px 9px;border:1.5px solid var(--neo-line);border-radius:9px;background:var(--neo-lime);font-size:.68rem;font-weight:900;opacity:0;transform:translateY(6px);transition:.18s}.neo-news-toast.show{opacity:1;transform:none}
    .neo-shortcut-shell{padding:12px}.neo-section-label{display:flex;align-items:center;gap:8px;margin-bottom:10px;font-size:.72rem;font-weight:950}.neo-section-label span{padding:4px 8px;border:1.5px solid var(--neo-line);border-radius:999px;background:var(--neo-yellow)}.neo-shortcuts{display:grid;grid-template-columns:repeat(6,1fr);gap:8px}.neo-shortcut{display:grid;justify-items:center;align-content:center;gap:6px;min-height:78px;padding:7px;border:1.6px solid var(--neo-line);border-radius:12px;background:var(--neo-white);cursor:pointer;text-align:center}.neo-shortcut:nth-child(2n){background:var(--neo-blue)}.neo-shortcut:nth-child(3n){background:var(--neo-mint)}.neo-shortcut i{font-style:normal;font-size:1.25rem;display:grid;place-items:center}.neo-shortcut i svg.icon{width:22px;height:22px}.neo-shortcut b{font-size:.62rem;line-height:1.15}
    .neo-action-stack{padding:12px}.neo-action-row{display:grid;grid-template-columns:46px 1fr auto;align-items:center;gap:10px;margin-top:9px;padding:10px;border:1.7px solid var(--neo-line);border-radius:13px;background:var(--neo-blue);cursor:pointer}.neo-action-row:nth-child(3){background:var(--neo-pink)}.neo-action-row:nth-child(4){background:var(--neo-mint)}.neo-action-row:nth-child(5){background:var(--neo-peach)}.neo-action-icon{display:grid;place-items:center;width:42px;height:42px;border:1.5px solid var(--neo-line);border-radius:10px;background:var(--neo-white);font-size:1.1rem}.neo-action-icon svg.icon{width:21px;height:21px}.neo-action-copy b{display:block;font-size:.84rem}.neo-action-copy small{display:block;font-size:.66rem;margin-top:2px}.neo-action-go{font-size:1.15rem;font-weight:950;display:grid;place-items:center}.neo-action-go svg.icon{width:18px;height:18px}.neo-coach-art svg.icon{width:27px;height:27px}.neo-profile-chip svg.icon{width:.85em;height:.85em;vertical-align:-.08em}.neo-arrow svg.icon,.neo-card-button svg.icon{width:.95em;height:.95em;vertical-align:-.12em}.neo-bottom-nav button.neo-main svg.icon{width:20px;height:20px}
    ...
    .aiads-chat-header{min-height:56px!important;padding:9px 10px!important;gap:7px!important;background:var(--neo-lime)!important;border-bottom:2px solid var(--neo-line)!important;backdrop-filter:none!important;flex-wrap:nowrap!important}.aiads-chat-header strong{color:var(--neo-ink)!important;font-size:14px!important}.aiads-chat-header small{display:none!important}.aiads-chat-header>div:first-child{flex:0 0 auto;min-width:0}.aiads-chat-header-controls{display:flex;align-items:center;gap:5px;min-width:0;flex:1}.aiads-chat-header-controls select{min-width:0!important;width:88px!important;height:34px!important;padding:0 22px 0 7px!important;background:var(--neo-white)!important;color:var(--neo-ink)!important;border:1.5px solid var(--neo-line)!important;border-radius:9px!important;font-size:10px!important}.aiads-chat-head-actions{margin-left:auto!important;gap:4px!important}.aiads-chat-icon{height:34px!important;min-width:34px!important;padding:0 8px!important;background:var(--neo-white)!important;color:var(--neo-ink)!important;border:1.5px solid var(--neo-line)!important;border-radius:9px!important;box-shadow:none!important;font-size:11px!important}.aiads-chat-controls{display:none!important}
    .aiads-chat-messages{padding:11px!important;gap:9px!important;background:var(--neo-paper)!important}.aiads-chat-empty{color:var(--neo-muted)!important}.aiads-chat-row{display:flex!important;align-items:flex-end!important;gap:6px!important;max-width:96%!important}.aiads-chat-row.user{align-self:flex-end!important;flex-direction:row-reverse!important}.aiads-chat-bubble{flex:0 1 auto!important;padding:9px 11px!important;border:1.5px solid var(--neo-line)!important;border-radius:13px!important;background:var(--neo-white)!important;color:var(--neo-ink)!important;font-size:13px!important;box-shadow:2px 2px 0 rgba(21,27,43,.08)!important}.aiads-chat-bubble.user{background:var(--neo-yellow)!important;color:var(--neo-ink)!important}.aiads-chat-meta{display:none!important}.aiads-chat-media{background:#e7eaed!important;border:1.5px solid var(--neo-line)!important}.aiads-chat-media-actions a,.aiads-chat-media-actions button{background:var(--neo-lime)!important;color:var(--neo-ink)!important;border:1.5px solid var(--neo-line)!important;box-shadow:none!important}
    .aiads-chat-attachments{background:var(--neo-paper)!important;padding:6px 9px 0!important}.aiads-chat-attachment{background:var(--neo-white)!important;border:1.5px solid var(--neo-line)!important}.aiads-chat-composer{padding:8px 9px calc(8px + env(safe-area-inset-bottom))!important;gap:6px!important;background:var(--neo-white)!important;border-top:2px solid var(--neo-line)!important}.aiads-chat-composer textarea{min-height:41px!important;max-height:110px!important;padding:9px 10px!important;background:var(--neo-paper)!important;color:var(--neo-ink)!important;border:1.5px solid var(--neo-line)!important;border-radius:11px!important;font-size:13px!important}.aiads-chat-attach,.aiads-chat-send,.aiads-chat-websearch{height:41px!important;min-width:41px!important;border:1.5px solid var(--neo-line)!important;border-radius:11px!important;box-shadow:none!important;color:var(--neo-ink)!important}.aiads-chat-attach{background:var(--neo-blue)!important}.aiads-chat-websearch{background:var(--neo-peach)!important}.aiads-chat-websearch:disabled{opacity:.5!important}.aiads-chat-send{background:var(--neo-lime)!important}.aiads-chat-error{background:var(--neo-pink)!important;color:#651824!important;border:1.5px solid var(--neo-line)!important}.aiads-chat-copy{flex:0 0 auto!important;margin-top:0!important;position:static!important;width:28px!important;height:28px!important;padding:0!important;display:grid!important;place-items:center!important;background:var(--neo-white)!important;color:var(--neo-muted)!important;border:1.5px solid var(--neo-line)!important;border-radius:9px!important;box-shadow:none!important;opacity:.8!important}.aiads-chat-copy svg,.aiads-chat-copy .icon{width:14px!important;height:14px!important}.aiads-chat-copy.copied{color:#1f7a43!important;background:var(--neo-mint)!important}
  ...
  function mountDashboard(){
    ...
    dashboard.innerHTML=`
      <div class="neo-profile-card">
        <div class="neo-profile-top"><div class="neo-profile-avatar">AI</div><div class="neo-profile-copy"><small>AI ADS LAB WORKSPACE</small><strong>Content Studio</strong></div><span class="neo-profile-chip">${ic('circle-dot')} READY</span></div>
      ...
      <div class="neo-coach-card" data-neo-target="text"><div class="neo-coach-art">${ic('sparkles')}</div><div class="neo-coach-copy"><b>Mulai dari Text Content</b><small>Buat carousel, preview, lalu kirim ke TikTok dalam satu alur.</small></div><button class="neo-arrow" type="button">Buka ${ic('arrow-right')}</button></div>
      <section class="neo-news-carousel" aria-labelledby="neo-news-title"><div class="neo-news-head"><b id="neo-news-title">Berita terbaru</b><small>Geser · tap untuk salin URL</small></div><div class="neo-news-track" data-news-track><div class="neo-news-empty">Memuat berita live…</div></div><span class="neo-news-toast" data-news-toast role="status" aria-live="polite"></span></section>
      <div class="neo-shortcut-shell"><div class="neo-section-label"><span>SERING DIPAKAI</span><small>6 pintasan</small></div><div class="neo-shortcuts">
        <div class="neo-shortcut" data-neo-target="assets"><i>${ic('image')}</i><b>Assets</b></div><div class="neo-shortcut" data-neo-target="generator"><i>${ic('wand-sparkles')}</i><b>Prompt</b></div><div class="neo-shortcut" data-neo-target="providers"><i>${ic('bot')}</i><b>Providers</b></div><div class="neo-shortcut" data-neo-target="templates"><i>${ic('clipboard-list')}</i><b>Templates</b></div><div class="neo-shortcut" data-neo-target="schedule"><i>${ic('calendar')}</i><b>Jadwal</b></div><div class="neo-shortcut" data-neo-target="history"><i>${ic('history')}</i><b>Riwayat</b></div>
      </div></div>
      <div class="neo-action-stack"><div class="neo-section-label"><span>TOOLS & WORKFLOW</span><small>Satu tempat produksi</small></div>
        <div class="neo-action-row" data-neo-target="factory"><div class="neo-action-icon">${ic('factory')}</div><div class="neo-action-copy"><b>AI Content Factory</b><small>Produksi konten dari template dan pipeline.</small></div><span class="neo-action-go">${ic('chevron-right')}</span></div>
        <div class="neo-action-row" data-neo-target="workflow"><div class="neo-action-icon">${ic('zap')}</div><div class="neo-action-copy"><b>Creative Workflow</b><small>Susun produksi end-to-end secara terarah.</small></div><span class="neo-action-go">${ic('chevron-right')}</span></div>
        <div class="neo-action-row" data-neo-target="assets"><div class="neo-action-icon">${ic('image')}</div><div class="neo-action-copy"><b>Asset Library</b><small>Gambar dan video lokal yang siap dipakai ulang.</small></div><span class="neo-action-go">${ic('chevron-right')}</span></div>
        <div class="neo-action-row" data-neo-target="providers"><div class="neo-action-icon">${ic('bot')}</div><div class="neo-action-copy"><b>AI Providers</b><small>Atur model teks, gambar, dan video.</small></div><span class="neo-action-go">${ic('chevron-right')}</span></div>
      </div>
      <div class="neo-home-banner"><div><b>Semua alat produksi dalam satu workspace.</b><small>Mulai dari ide, buat visual, simpan sementara di VPS, lalu kirim ke TikTok.</small></div><button type="button" data-neo-target="studio">Mulai membuat ${ic('arrow-right')}</button></div>
  ...
  function mountBottomNav(){
    ...
    nav.innerHTML=`<button type="button" data-neo-target="home" class="active"><i>${ic('house')}</i><span>Beranda</span></button><button type="button" data-neo-target="text"><i>${ic('type')}</i><span>Text</span></button><button type="button" data-neo-target="studio" class="neo-main"><i>${ic('sparkles')}</i><span>Buat</span></button><button type="button" data-neo-target="assets"><i>${ic('image')}</i><span>Assets</span></button><button type="button" data-neo-target="profile"><i>${ic('user-round')}</i><span>Akun</span></button>`;
