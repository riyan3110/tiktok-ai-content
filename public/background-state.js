...
(() => {
  ...
  textField.innerHTML = 'Teks carousel siap tempel<textarea id="manual-text-input" rows="12" maxlength="20000" placeholder="Tempel copy dengan bagian HOOK, FAKTA UTAMA, DETAIL, PENUTUP, lalu CAPTION dan TAGAR bila ada. AI Ads Lab akan mengenali tiap bagian dan menaruhnya pada slot yang sesuai."></textarea><small>HOOK, judul, body, bullet, PENUTUP, CAPTION, dan TAGAR dipisahkan menurut fungsinya; label bagian tidak ikut tampil di gambar. Jika body sedikit terlalu panjang, sistem hanya memendekkan dari teks yang kamu tempel tanpa menambah klaim baru.</small>';
