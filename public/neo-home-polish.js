(() => {
  ...
  style.textContent = `
    ...
    .aiads-neo-theme .page-content{width:min(calc(100% - 40px),1280px)!important;max-width:1280px!important;min-width:0!important;margin-inline:auto!important}
    ...
    /* AI Providers uses the same viewport scale as every other page. */
    .aiads-neo-theme #ai-providers,.aiads-neo-theme #ai-providers .provider-heading,.aiads-neo-theme #ai-providers .provider-defaults,.aiads-neo-theme #ai-providers .provider-layout,.aiads-neo-theme #ai-providers .provider-sidebar,.aiads-neo-theme #ai-providers .provider-detail,.aiads-neo-theme #ai-providers .provider-form,.aiads-neo-theme #ai-providers .form-grid{width:auto!important;max-width:100%!important;min-width:0!important;box-sizing:border-box!important}
    .aiads-neo-theme #ai-providers{width:100%!important}
    .aiads-neo-theme #ai-providers .provider-layout{width:100%!important;grid-template-columns:minmax(220px,260px) minmax(0,1fr)!important;min-height:0!important;overflow:hidden!important}
    ...
    .aiads-neo-theme #ai-providers .provider-detail{width:100%!important;padding:22px!important;overflow:hidden!important}
    .aiads-neo-theme #ai-providers .provider-form *{max-width:100%;min-width:0}
    .aiads-neo-theme #ai-providers .provider-form .form-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}
    ...
    @media(max-width:900px){
      .aiads-neo-theme #ai-providers .provider-layout{grid-template-columns:minmax(190px,220px) minmax(0,1fr)!important}
      .aiads-neo-theme #ai-providers .provider-detail{padding:18px!important}
    }
    @media(max-width:767px){
      .aiads-neo-theme .topbar{justify-content:flex-end!important}
      .aiads-neo-theme .page-content{width:calc(100% - 20px)!important;max-width:none!important}
      ...
      .aiads-neo-theme #ai-providers .provider-heading{display:block!important}
      .aiads-neo-theme #ai-providers .provider-heading h1{font-size:clamp(1.75rem,9vw,2.25rem)!important;line-height:1.02!important;overflow-wrap:anywhere!important}
      ...
      .aiads-neo-theme #ai-providers .provider-item{flex:0 0 min(190px,72vw)!important;width:auto!important}
      ...
      .aiads-neo-theme #ai-providers .provider-form label>div{max-width:100%!important}
    ...
    @media(min-width:1024px){
      .aiads-neo-theme .page-content{width:min(calc(100% - 64px),1280px)!important;padding-top:32px!important}
