...
test('Content Studio menyediakan selector background carousel yang persisten dan mobile-safe', () => {
  ...
  for (const value of ['Background Konten', '#E9E1D3', 'Unggah dari perangkat', 'Terapkan ke semua slide', 'Reset Background', 'accept="image/png,image/jpeg,image/webp"']) assert.match(html, new RegExp(value.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')));
