...
test('global shell, lazy loader and redesign are cache-busted and deferred from head', () => {
  ...
  assert.match(source, /<script defer src=\"\/neo-home-polish\.js\?v=home-polish-20260826i\"><\/script>/);
...
test('stable responsive styles are loaded on every fresh app shell', () => {
  ...
  assert.match(source, /<link rel=\"stylesheet\" href=\"\/responsive-professional\.css\?v=responsive-20260826c\">/);
});
